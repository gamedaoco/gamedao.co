...
declare module '@polkadot/api/types/errors' {
  export interface AugmentedErrors<ApiType> {
    ...
    hypaspace: {
       ...
       **/
      MaterializationFailed: AugmentedError<ApiType>;
      /**
       * Entity Exists
       **/
      SpaceExists: AugmentedError<ApiType>;
      /**
       * Entity Unknown
       **/
      SpaceUnknown: AugmentedError<ApiType>;
    };
    identity: {
      [key: string]: AugmentedError<ApiType>;
      /**
    ...
    zeroItem: {
      ...
      NonexistentItem: AugmentedError<ApiType>;
      NotItemOwner: AugmentedError<ApiType>;
