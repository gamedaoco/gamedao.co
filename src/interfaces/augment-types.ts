...
import type { BConfig, Body, BurnedIndex, CID, Campaign, ClassIndex, ControlAccessModel, ControlFeeModel, ControlMemberState, ControlState, ControlType, Entity, EntityProperty, EventMessage, FlowGovernance, FlowProtocol, FlowState, ItemIndex, Nonce, ProposalMetadata, ProposalState, ProposalType, RealmIndex, State, TangramClass, TangramClassMetadata, TangramId, TangramItem, TangramItemOf, TangramMetadata, TangramRealm, TangramRealmMetadata, Timestamp, TitleText, TotalIndex, VotingType, campaign_id, contribution } from 'sample-polkadotjs-typegen/interfaces/common';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Compact<BurnedIndex>': Compact<BurnedIndex>;
    'Compact<ClassId>': Compact<ClassId>;
    'Compact<ClassIndex>': Compact<ClassIndex>;
    'Compact<ContractDiscriminant>': Compact<ContractDiscriminant>;
    'Compact<contribution>': Compact<contribution>;
    'Compact<ControlAccessModel>': Compact<ControlAccessModel>;
    'Compact<ControlFeeModel>': Compact<ControlFeeModel>;
    'Compact<ControlMemberState>': Compact<ControlMemberState>;
    'Compact<ControlState>': Compact<ControlState>;
    'Compact<ControlType>': Compact<ControlType>;
    ...
    'Compact<FlowGovernance>': Compact<FlowGovernance>;
    'Compact<FlowProtocol>': Compact<FlowProtocol>;
    'Compact<FlowState>': Compact<FlowState>;
    ...
    'Compact<ItemIndex>': Compact<ItemIndex>;
    ...
    'Compact<ProposalState>': Compact<ProposalState>;
    'Compact<ProposalType>': Compact<ProposalType>;
    'Compact<RealmIndex>': Compact<RealmIndex>;
    ...
    'Compact<TotalIndex>': Compact<TotalIndex>;
    ...
    'Compact<VotingType>': Compact<VotingType>;
    ...
    'Option<BurnedIndex>': Option<BurnedIndex>;
    ...
    'Option<campaign_id>': Option<campaign_id>;
    ...
    'Option<ClassIndex>': Option<ClassIndex>;
    ...
    'Option<ControlAccessModel>': Option<ControlAccessModel>;
    'Option<ControlFeeModel>': Option<ControlFeeModel>;
    'Option<ControlMemberState>': Option<ControlMemberState>;
    'Option<ControlState>': Option<ControlState>;
    'Option<ControlType>': Option<ControlType>;
    ...
    'Option<FlowGovernance>': Option<FlowGovernance>;
    'Option<FlowProtocol>': Option<FlowProtocol>;
    'Option<FlowState>': Option<FlowState>;
    ...
    'Option<ProposalMetadata>': Option<ProposalMetadata>;
    'Option<ProposalState>': Option<ProposalState>;
    'Option<ProposalType>': Option<ProposalType>;
    ...
    'Option<RealmIndex>': Option<RealmIndex>;
    ...
    'Option<TangramClass>': Option<TangramClass>;
    'Option<TangramClassMetadata>': Option<TangramClassMetadata>;
    'Option<TangramId>': Option<TangramId>;
    'Option<TangramItem>': Option<TangramItem>;
    'Option<TangramItemOf>': Option<TangramItemOf>;
    'Option<TangramMetadata>': Option<TangramMetadata>;
    'Option<TangramRealm>': Option<TangramRealm>;
    'Option<TangramRealmMetadata>': Option<TangramRealmMetadata>;
    ...
    'Option<VotingType>': Option<VotingType>;
    ...
    'Vec<ControlAccessModel>': Vec<ControlAccessModel>;
    'Vec<ControlFeeModel>': Vec<ControlFeeModel>;
    'Vec<ControlMemberState>': Vec<ControlMemberState>;
    'Vec<ControlState>': Vec<ControlState>;
    'Vec<ControlType>': Vec<ControlType>;
    ...
    'Vec<FlowGovernance>': Vec<FlowGovernance>;
    'Vec<FlowProtocol>': Vec<FlowProtocol>;
    'Vec<FlowState>': Vec<FlowState>;
    ...
    'Vec<ProposalMetadata>': Vec<ProposalMetadata>;
    'Vec<ProposalState>': Vec<ProposalState>;
    'Vec<ProposalType>': Vec<ProposalType>;
    ...
    'Vec<Tally>': Vec<Tally>;
    'Vec<TangramClass>': Vec<TangramClass>;
    'Vec<TangramClassMetadata>': Vec<TangramClassMetadata>;
    'Vec<TangramId>': Vec<TangramId>;
    'Vec<TangramItem>': Vec<TangramItem>;
    'Vec<TangramItemOf>': Vec<TangramItemOf>;
    'Vec<TangramMetadata>': Vec<TangramMetadata>;
    'Vec<TangramRealm>': Vec<TangramRealm>;
    'Vec<TangramRealmMetadata>': Vec<TangramRealmMetadata>;
    ...
    ControlAccessModel: ControlAccessModel;
    ControlFeeModel: ControlFeeModel;
    ControlMemberState: ControlMemberState;
    ...
    Tally: Tally;
    TangramClass: TangramClass;
    TangramClassMetadata: TangramClassMetadata;
    TangramId: TangramId;
    TangramItem: TangramItem;
    TangramItemOf: TangramItemOf;
    TangramMetadata: TangramMetadata;
    TangramRealm: TangramRealm;
    TangramRealmMetadata: TangramRealmMetadata;
