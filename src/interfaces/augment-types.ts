...
import type { CID, Campaign, Entity, EntityProperty, EventMessage, Governance, HypaspaceInfo, HypaspaceMetadata, Item, ItemId, ItemInfo, Nonce, SpaceId, Timestamp } from 'sample-polkadotjs-typegen/interfaces/common';
