...
import type { Campaign } from 'sample-polkadotjs-typegen/interfaces/crowdfunding';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    crowdfunding: {
      [key: string]: QueryableStorageEntry<ApiType>;
      allCampaignsArray: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Hash>> & QueryableStorageEntry<ApiType>;
      allCampaignsCount: AugmentedQuery<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
      allCampaignsIndex: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      campaignOwner: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<AccountId>>> & QueryableStorageEntry<ApiType>;
      /**
       * Get one or all Campaigns
       **/
      campaigns: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Campaign>> & QueryableStorageEntry<ApiType>;
      /**
       * Campaigns ending in block x
       **/
      campaignsByBlockNumber: AugmentedQuery<ApiType, (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<Vec<Hash>>> & QueryableStorageEntry<ApiType>;
      /**
       * Campaign state
       * status: 0 not started, 1 in progress, 2 success, 3 fail
       **/
      campaignState: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u8>> & QueryableStorageEntry<ApiType>;
      contributedAmount: AugmentedQuery<ApiType, (arg: ITuple<[Hash, AccountId]> | [Hash | string | Uint8Array, AccountId | string | Uint8Array]) => Observable<Balance>> & QueryableStorageEntry<ApiType>;
      contributedCampaignsArray: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>> & QueryableStorageEntry<ApiType>;
      contributedCampaignsCount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      contributedCampaignsIndex: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, Hash]> | [AccountId | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      contributorAccounts: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Vec<AccountId>>> & QueryableStorageEntry<ApiType>;
      contributorAccountsCount: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      nonce: AugmentedQuery<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
      ownedCampaignsArray: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>> & QueryableStorageEntry<ApiType>;
      ownedCampaignsCount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      ownedCampaignsIndex: AugmentedQuery<ApiType, (arg: ITuple<[AccountId, Hash]> | [AccountId | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      totalContributions: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Balance>> & QueryableStorageEntry<ApiType>;
    };
    democracy: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
    ...
    proxy: {
       ...
       **/
      announcements: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<ITuple<[Vec<ProxyAnnouncement>, BalanceOf]>>> & QueryableStorageEntry<ApiType>;
      /**
       * The set of account proxies. Maps the account which has delegated to the accounts
       * which are being delegated to, together with the amount held on deposit.
       **/
      proxies: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<ITuple<[Vec<ProxyDefinition>, BalanceOf]>>> & QueryableStorageEntry<ApiType>;
    };
