...
import type { Bytes, Data, Option, U8aFixed, Vec, bool, u128, u32, u64, u8 } from '@polkadot/types'
...
import type { Campaign, Entity, EntityProperty, HypaspaceMetadata, Item, ItemId } from 'sample-polkadotjs-typegen/interfaces/common'
...
declare module '@polkadot/api/types/storage' {
	export interface AugmentedQueries<ApiType> {
		assets: {
			 ...
			 **/
			account: AugmentedQueryDoubleMap<
				ApiType,
				(key1: AssetId | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<AssetBalance>,
				[AssetId, AccountId]
			> &
				QueryableStorageEntry<ApiType, [AssetId, AccountId]>
			/**
			 * Details of an asset.
			 **/
			asset: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<Option<AssetDetails>>, [AssetId]> &
				QueryableStorageEntry<ApiType, [AssetId]>
			/**
			 * Metadata of an asset.
			 **/
			metadata: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<AssetMetadata>, [AssetId]> &
				QueryableStorageEntry<ApiType, [AssetId]>
		}
		authorship: {
			[key: string]: QueryableStorageEntry<ApiType>
		...
		bounties: {
			...
			bounties: AugmentedQuery<ApiType, (arg: BountyIndex | AnyNumber | Uint8Array) => Observable<Option<Bounty>>, [BountyIndex]> &
				QueryableStorageEntry<ApiType, [BountyIndex]>
			/**
		...
		contracts: {
			...
			codeStorage: AugmentedQuery<ApiType, (arg: CodeHash | string | Uint8Array) => Observable<Option<PrefabWasmModule>>, [CodeHash]> &
				QueryableStorageEntry<ApiType, [CodeHash]>
			/**
		...
		democracy: {
			...
			depositOf: AugmentedQuery<
				ApiType,
				(arg: PropIndex | AnyNumber | Uint8Array) => Observable<Option<ITuple<[Vec<AccountId>, BalanceOf]>>>,
				[PropIndex]
			> &
				QueryableStorageEntry<ApiType, [PropIndex]>
			/**
			...
			referendumInfoOf: AugmentedQuery<
				ApiType,
				(arg: ReferendumIndex | AnyNumber | Uint8Array) => Observable<Option<ReferendumInfo>>,
				[ReferendumIndex]
			> &
				QueryableStorageEntry<ApiType, [ReferendumIndex]>
			/**
			 * Storage version of the pallet.
			 *
		...
		gameDaoCrowdfunding: {
			 ...
			 **/
			campaignAdmin: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<AccountId>>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			...
			campaignContribution: AugmentedQuery<
				ApiType,
				(arg: ITuple<[Hash, AccountId]> | [Hash | string | Uint8Array, AccountId | string | Uint8Array]) => Observable<Balance>,
				[ITuple<[Hash, AccountId]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[Hash, AccountId]>]>
			campaignContributors: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Vec<AccountId>>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			campaignContributorsCount: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u64>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			/**
			 ...
			 **/
			campaignOwner: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<AccountId>>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			/**
			 ...
			 **/
			campaignsByBlock: AugmentedQuery<ApiType, (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<Vec<Hash>>, [BlockNumber]> &
				QueryableStorageEntry<ApiType, [BlockNumber]>
			campaignsContributedArray: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>,
				[ITuple<[AccountId, u64]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[AccountId, u64]>]>
			campaignsContributedCount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			campaignsContributedIndex: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, Hash]> | [AccountId | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>,
				[ITuple<[AccountId, Hash]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[AccountId, Hash]>]>
			...
			campaignsOwnedArray: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>,
				[ITuple<[AccountId, u64]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[AccountId, u64]>]>
			campaignsOwnedCount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			campaignsOwnedIndex: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, Hash]> | [AccountId | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>,
				[ITuple<[AccountId, Hash]>]
			> &
			 ...
			 **/
			campaignState: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u8>, [Hash]> & QueryableStorageEntry<ApiType, [Hash]>
			nonce: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>
		}
		gameDaoGovernance: {
			[key: string]: QueryableStorageEntry<ApiType>
			campaignBalanceUsed: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Balance>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			nonce: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>
			proposalOwner: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<AccountId>>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			...
			proposalsByBlock: AugmentedQuery<ApiType, (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<Vec<Hash>>, [BlockNumber]> &
				QueryableStorageEntry<ApiType, [BlockNumber]>
			proposalsByCampaignArray: AugmentedQuery<
				ApiType,
				(arg: ITuple<[Hash, u64]> | [Hash | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>,
				[ITuple<[Hash, u64]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[Hash, u64]>]>
			proposalsByCampaignCount: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u64>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
			proposalsByCampaignIndex: AugmentedQuery<
				ApiType,
				(arg: ITuple<[Hash, Hash]> | [Hash | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>,
				[ITuple<[Hash, Hash]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[Hash, Hash]>]>
			proposalsByOwnerArray: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, u64]> | [AccountId | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>,
				[ITuple<[AccountId, u64]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[AccountId, u64]>]>
			proposalsByOwnerCount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			proposalsByOwnerIndex: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, Hash]> | [AccountId | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>,
				[ITuple<[AccountId, Hash]>]
			> &
			...
			proposalStatus: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u8>, [Hash]> & QueryableStorageEntry<ApiType, [Hash]>
			proposalSupporters: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u64>, [Hash]> & QueryableStorageEntry<ApiType, [Hash]>
			proposalTimeLimit: AugmentedQuery<ApiType, () => Observable<BlockNumber>, []> & QueryableStorageEntry<ApiType, []>
			votedBefore: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, Hash]> | [AccountId | string | Uint8Array, Hash | string | Uint8Array]) => Observable<bool>,
				[ITuple<[AccountId, Hash]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[AccountId, Hash]>]>
		}
		...
		hypaspace: {
			[key: string]: QueryableStorageEntry<ApiType>
			metadataForSpace: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<HypaspaceMetadata>, [Hash]> &
				QueryableStorageEntry<ApiType, [Hash]>
		}
		identity: {
			[key: string]: QueryableStorageEntry<ApiType>
		...
		imOnline: {
			...
			authoredBlocks: AugmentedQueryDoubleMap<
				ApiType,
				(key1: SessionIndex | AnyNumber | Uint8Array, key2: ValidatorId | string | Uint8Array) => Observable<u32>,
				[SessionIndex, ValidatorId]
			> &
				QueryableStorageEntry<ApiType, [SessionIndex, ValidatorId]>
			/**
			...
			receivedHeartbeats: AugmentedQueryDoubleMap<
				ApiType,
				(key1: SessionIndex | AnyNumber | Uint8Array, key2: AuthIndex | AnyNumber | Uint8Array) => Observable<Option<Bytes>>,
				[SessionIndex, AuthIndex]
			> &
				QueryableStorageEntry<ApiType, [SessionIndex, AuthIndex]>
		}
		indices: {
			[key: string]: QueryableStorageEntry<ApiType>
			/**
			...
			accounts: AugmentedQuery<
				ApiType,
				(arg: AccountIndex | AnyNumber | Uint8Array) => Observable<Option<ITuple<[AccountId, BalanceOf, bool]>>>,
				[AccountIndex]
			> &
				QueryableStorageEntry<ApiType, [AccountIndex]>
		}
		lottery: {
			[key: string]: QueryableStorageEntry<ApiType>
			/**
			 ...
			 **/
			participants: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<ITuple<[u32, Vec<CallIndex>]>>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			/**
			 * Each ticket's owner.
			 *
			 ...
			 **/
			tickets: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<AccountId>>, [u32]> &
				QueryableStorageEntry<ApiType, [u32]>
			/**
		...
		multisig: {
			...
			calls: AugmentedQuery<
				ApiType,
				(arg: U8aFixed | string | Uint8Array) => Observable<Option<ITuple<[OpaqueCall, AccountId, BalanceOf]>>>,
				[U8aFixed]
			> &
			 ...
			 **/
			multisigs: AugmentedQueryDoubleMap<
				ApiType,
				(key1: AccountId | string | Uint8Array, key2: U8aFixed | string | Uint8Array) => Observable<Option<Multisig>>,
				[AccountId, U8aFixed]
			> &
				QueryableStorageEntry<ApiType, [AccountId, U8aFixed]>
		}
		offences: {
			[key: string]: QueryableStorageEntry<ApiType>
			/**
			...
			concurrentReportsIndex: AugmentedQueryDoubleMap<
				ApiType,
				(key1: Kind | string | Uint8Array, key2: OpaqueTimeSlot | string | Uint8Array) => Observable<Vec<ReportIdOf>>,
				[Kind, OpaqueTimeSlot]
			> &
				QueryableStorageEntry<ApiType, [Kind, OpaqueTimeSlot]>
			/**
			...
			reports: AugmentedQuery<ApiType, (arg: ReportIdOf | string | Uint8Array) => Observable<Option<OffenceDetails>>, [ReportIdOf]> &
				QueryableStorageEntry<ApiType, [ReportIdOf]>
			/**
		...
		recovery: {
			...
			activeRecoveries: AugmentedQueryDoubleMap<
				ApiType,
				(key1: AccountId | string | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<ActiveRecovery>>,
				[AccountId, AccountId]
			> &
				QueryableStorageEntry<ApiType, [AccountId, AccountId]>
			/**
		...
		session: {
			...
			keyOwner: AugmentedQuery<
				ApiType,
				(arg: ITuple<[KeyTypeId, Bytes]> | [KeyTypeId | AnyNumber | Uint8Array, Bytes | string | Uint8Array]) => Observable<Option<ValidatorId>>,
				[ITuple<[KeyTypeId, Bytes]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[KeyTypeId, Bytes]>]>
			/**
			 * The next session keys for a validator.
			 **/
			nextKeys: AugmentedQuery<ApiType, (arg: ValidatorId | string | Uint8Array) => Observable<Option<Keys>>, [ValidatorId]> &
				QueryableStorageEntry<ApiType, [ValidatorId]>
			/**
		...
		society: {
			...
			suspendedCandidates: AugmentedQuery<
				ApiType,
				(arg: AccountId | string | Uint8Array) => Observable<Option<ITuple<[BalanceOf, BidKind]>>>,
				[AccountId]
			> &
				QueryableStorageEntry<ApiType, [AccountId]>
			/**
			...
			votes: AugmentedQueryDoubleMap<
				ApiType,
				(key1: AccountId | string | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<SocietyVote>>,
				[AccountId, AccountId]
			> &
				QueryableStorageEntry<ApiType, [AccountId, AccountId]>
			/**
		...
		staking: {
			...
			erasRewardPoints: AugmentedQuery<ApiType, (arg: EraIndex | AnyNumber | Uint8Array) => Observable<EraRewardPoints>, [EraIndex]> &
				QueryableStorageEntry<ApiType, [EraIndex]>
			/**
			...
			erasStakers: AugmentedQueryDoubleMap<
				ApiType,
				(key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Exposure>,
				[EraIndex, AccountId]
			> &
				QueryableStorageEntry<ApiType, [EraIndex, AccountId]>
			/**
			...
			erasValidatorPrefs: AugmentedQueryDoubleMap<
				ApiType,
				(key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<ValidatorPrefs>,
				[EraIndex, AccountId]
			> &
				QueryableStorageEntry<ApiType, [EraIndex, AccountId]>
			/**
			...
			nominatorSlashInEra: AugmentedQueryDoubleMap<
				ApiType,
				(key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<BalanceOf>>,
				[EraIndex, AccountId]
			> &
				QueryableStorageEntry<ApiType, [EraIndex, AccountId]>
			/**
			...
			spanSlash: AugmentedQuery<
				ApiType,
				(arg: ITuple<[AccountId, SpanIndex]> | [AccountId | string | Uint8Array, SpanIndex | AnyNumber | Uint8Array]) => Observable<SpanRecord>,
				[ITuple<[AccountId, SpanIndex]>]
			> &
				QueryableStorageEntry<ApiType, [ITuple<[AccountId, SpanIndex]>]>
			/**
			...
			validatorSlashInEra: AugmentedQueryDoubleMap<
				ApiType,
				(key1: EraIndex | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<ITuple<[Perbill, BalanceOf]>>>,
				[EraIndex, AccountId]
			> &
				QueryableStorageEntry<ApiType, [EraIndex, AccountId]>
		}
		...
		treasury: {
			...
			proposals: AugmentedQuery<ApiType, (arg: ProposalIndex | AnyNumber | Uint8Array) => Observable<Option<TreasuryProposal>>, [ProposalIndex]> &
				QueryableStorageEntry<ApiType, [ProposalIndex]>
		}
		vesting: {
			[key: string]: QueryableStorageEntry<ApiType>
			/**
		...
		zeroItem: {
			 ...
			 **/
			accountForItem: AugmentedQuery<ApiType, (arg: ItemId | string | Uint8Array) => Observable<AccountId>, [ItemId]> &
				QueryableStorageEntry<ApiType, [ItemId]>
			/**
			 * The total number of this type of item that has been burned (may overflow).
			 **/
			burned: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>
			/**
			 * A mapping from an account to a list of all of the items of this type that are owned by it.
			 **/
			itemsForAccount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Vec<Item>>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			/**
			 ...
			 **/
			totalForAccount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
		}
		zeroSense: {
			[key: string]: QueryableStorageEntry<ApiType>
			 ...
			 * A Sense Entity
			 **/
			sense: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Entity>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			/**
			 * REP across the metaverse
			 **/
			senseRep: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<EntityProperty>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			/**
			 * Trust score across the metaverse
			 **/
			senseTrust: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<EntityProperty>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
			/**
			 * XP across the metaverse
			 **/
			senseXp: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<EntityProperty>, [AccountId]> &
				QueryableStorageEntry<ApiType, [AccountId]>
		}
	}
