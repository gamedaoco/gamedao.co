...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    gameDaoGovernance: {
      ...
      nonce: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      proposalOwner: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Option<AccountId>>, [Hash]> & QueryableStorageEntry<ApiType, [Hash]>;
      ...
      proposalsByCampaignArray: AugmentedQuery<ApiType, (arg: ITuple<[Hash, u64]> | [Hash | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>, [ITuple<[Hash, u64]>]> & QueryableStorageEntry<ApiType, [ITuple<[Hash, u64]>]>;
      proposalsByCampaignCount: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u64>, [Hash]> & QueryableStorageEntry<ApiType, [Hash]>;
      proposalsByCampaignIndex: AugmentedQuery<ApiType, (arg: ITuple<[Hash, Hash]> | [Hash | string | Uint8Array, Hash | string | Uint8Array]) => Observable<u64>, [ITuple<[Hash, Hash]>]> & QueryableStorageEntry<ApiType, [ITuple<[Hash, Hash]>]>;
    ...
    hypaspace: {
      [key: string]: QueryableStorageEntry<ApiType>;
      metadataForSpace: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<HypaspaceMetadata>, [Hash]> & QueryableStorageEntry<ApiType, [Hash]>;
    };
    identity: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
    ...
    zeroItem: {
       ...
       **/
      accountForItem: AugmentedQuery<ApiType, (arg: ItemId | string | Uint8Array) => Observable<AccountId>, [ItemId]> & QueryableStorageEntry<ApiType, [ItemId]>;
      /**
       ...
       **/
      itemsForAccount: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Vec<Item>>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
