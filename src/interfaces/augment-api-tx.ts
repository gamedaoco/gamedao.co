...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    crowdfunding: {
       ...
       **/
      contribute: AugmentedSubmittable<(campaign: Hash | string | Uint8Array, contribution: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      create: AugmentedSubmittable<(name: Bytes | string | Uint8Array, target: Balance | AnyNumber | Uint8Array, deposit: Balance | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      updateStatus: AugmentedSubmittable<(campaign: Hash | string | Uint8Array, status: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    democracy: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       * reasonable value).
       **/
      blacklist: AugmentedSubmittable<(proposalHash: Hash | string | Uint8Array, maybeRefIndex: Option<ReferendumIndex> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove a proposal.
       * 
       ...
       **/
      cancelProposal: AugmentedSubmittable<(propIndex: Compact<PropIndex> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
