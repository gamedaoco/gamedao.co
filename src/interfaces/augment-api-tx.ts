...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    gameDaoCrowdfunding: {
      ...
      create: AugmentedSubmittable<(admin: AccountId | string | Uint8Array, name: Bytes | string | Uint8Array, target: Balance | AnyNumber | Uint8Array, deposit: Balance | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array, protocol: u8 | AnyNumber | Uint8Array, governance: u8 | AnyNumber | Uint8Array, cid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, Bytes, Balance, Balance, BlockNumber, u8, u8, Bytes]>;
      updateStatus: AugmentedSubmittable<(campaignId: Hash | string | Uint8Array, status: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, u8]>;
    };
    gameDaoGovernance: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      createProposal: AugmentedSubmittable<(campaignId: Hash | string | Uint8Array, purpose: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, Bytes, Bytes, Balance, BlockNumber]>;
    ...
    zeroItem: {
       ...
       **/
      mint: AugmentedSubmittable<(ownerAccount: AccountId | string | Uint8Array, itemInfo: ItemInfo | { dob?: any; dna?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, ItemInfo]>;
      /**
       ...
       * of the info that defines the item to destroy.
       **/
      transfer: AugmentedSubmittable<(destAccount: AccountId | string | Uint8Array, itemId: ItemId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, ItemId]>;
    };
    zeroSense: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
