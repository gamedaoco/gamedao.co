...
import type { ClassIndex, ControlAccessModel, ControlFeeModel, ControlType, FlowGovernance, FlowProtocol, FlowState, RealmIndex } from 'sample-polkadotjs-typegen/interfaces/common';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    council: {
       ...
       * # </weight>
       **/
      execute: AugmentedSubmittable<(proposal: Proposal | { proposal_id?: any; context_id?: any; proposal_type?: any; voting_type?: any; start?: any; expiry?: any } | string | Uint8Array, lengthBound: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Proposal, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      propose: AugmentedSubmittable<(threshold: Compact<MemberCount> | AnyNumber | Uint8Array, proposal: Proposal | { proposal_id?: any; context_id?: any; proposal_type?: any; voting_type?: any; start?: any; expiry?: any } | string | Uint8Array, lengthBound: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<MemberCount>, Proposal, Compact<u32>]>;
      /**
    ...
    gameDaoControl: {
      addMember: AugmentedSubmittable<(hash: Hash | string | Uint8Array, account: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, AccountId]>;
      checkMembership: AugmentedSubmittable<(hash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash]>;
      create: AugmentedSubmittable<(controller: AccountId | string | Uint8Array, treasury: AccountId | string | Uint8Array, name: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array, body: ControlType | AnyNumber | Uint8Array, access: ControlAccessModel | AnyNumber | Uint8Array, feeModel: ControlFeeModel | AnyNumber | Uint8Array, fee: Balance | AnyNumber | Uint8Array, govAsset: u8 | AnyNumber | Uint8Array, payAsset: u8 | AnyNumber | Uint8Array, memberLimit: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, AccountId, Bytes, Bytes, ControlType, ControlAccessModel, ControlFeeModel, Balance, u8, u8, u64]>;
      disable: AugmentedSubmittable<(hash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash]>;
      enable: AugmentedSubmittable<(hash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash]>;
      removeMember: AugmentedSubmittable<(hash: Hash | string | Uint8Array, account: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, AccountId]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    gameDaoCrowdfunding: {
       ...
       **/
      contribute: AugmentedSubmittable<(campaignId: Hash | string | Uint8Array, contribution: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, Balance]>;
      create: AugmentedSubmittable<(org: Hash | string | Uint8Array, admin: AccountId | string | Uint8Array, name: Bytes | string | Uint8Array, target: Balance | AnyNumber | Uint8Array, deposit: Balance | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array, protocol: FlowProtocol | AnyNumber | Uint8Array, governance: FlowGovernance | AnyNumber | Uint8Array, cid: Bytes | string | Uint8Array, tokenSymbol: Bytes | string | Uint8Array, tokenName: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, AccountId, Bytes, Balance, Balance, BlockNumber, FlowProtocol, FlowGovernance, Bytes, Bytes, Bytes]>;
      destroy: AugmentedSubmittable<(id: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash]>;
      updateState: AugmentedSubmittable<(campaignId: Hash | string | Uint8Array, state: FlowState | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, FlowState]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    gameDaoGovernance: {
      generalProposal: AugmentedSubmittable<(contextId: Hash | string | Uint8Array, title: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array, start: BlockNumber | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, Bytes, Bytes, BlockNumber, BlockNumber]>;
      membershipProposal: AugmentedSubmittable<(context: Hash | string | Uint8Array, member: Hash | string | Uint8Array, action: u8 | AnyNumber | Uint8Array, start: BlockNumber | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, Hash, u8, BlockNumber, BlockNumber]>;
      simpleVote: AugmentedSubmittable<(proposalId: Hash | string | Uint8Array, vote: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, bool]>;
      withdrawProposal: AugmentedSubmittable<(contextId: Hash | string | Uint8Array, title: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array, start: BlockNumber | AnyNumber | Uint8Array, expiry: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash, Bytes, Bytes, Balance, BlockNumber, BlockNumber]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    gameDaoTangram: {
      createClass: AugmentedSubmittable<(realm: RealmIndex | AnyNumber | Uint8Array, name: Bytes | string | Uint8Array, max: u64 | AnyNumber | Uint8Array, strategy: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [RealmIndex, Bytes, u64, u64]>;
      createItem: AugmentedSubmittable<(realm: RealmIndex | AnyNumber | Uint8Array, clazz: ClassIndex | AnyNumber | Uint8Array, name: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array, who: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [RealmIndex, ClassIndex, Bytes, Bytes, AccountId]>;
      createRealm: AugmentedSubmittable<(org: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Hash]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    zeroSense: {
      createEntity: AugmentedSubmittable<(account: AccountId | string | Uint8Array, cid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, Bytes]>;
      modRep: AugmentedSubmittable<(account: AccountId | string | Uint8Array, value: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, u8]>;
      modTrust: AugmentedSubmittable<(account: AccountId | string | Uint8Array, value: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, u8]>;
      modXp: AugmentedSubmittable<(account: AccountId | string | Uint8Array, value: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, u8]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
