...
import type { EventMessage, ItemId, SpaceId } from 'sample-polkadotjs-typegen/interfaces/common'
...
declare module '@polkadot/api/types/events' {
	export interface AugmentedEvents<ApiType> {
		...
		gameDaoCrowdfunding: {
			...
			CampaignUpdated: AugmentedEvent<ApiType, [Hash, u8, BlockNumber]>
		...
		gameDaoGovernance: {
			...
			ProposalFinalized: AugmentedEvent<ApiType, [Hash, u64, BlockNumber, bool]>
			ProposalVoted: AugmentedEvent<ApiType, [AccountId, Hash]>
		}
		grandpa: {
			[key: string]: AugmentedEvent<ApiType>
			/**
		...
		hypaspace: {
			[key: string]: AugmentedEvent<ApiType>
			Materialize: AugmentedEvent<ApiType, [SpaceId, AccountId]>
		}
		identity: {
			[key: string]: AugmentedEvent<ApiType>
			/**
		...
		zeroItem: {
			 ...
			 **/
			Burned: AugmentedEvent<ApiType, [ItemId]>
			/**
			 * The item has been minted and distributed to the account.
			 **/
			Minted: AugmentedEvent<ApiType, [ItemId, AccountId]>
			/**
			 * Ownership of the item has been transferred to the account.
			 **/
			Transferred: AugmentedEvent<ApiType, [ItemId, AccountId]>
		}
		zeroSense: {
			[key: string]: AugmentedEvent<ApiType>
