...
declare module '@polkadot/api/types/consts' {
  export interface AugmentedConsts<ApiType> {
    ...
    gameDaoTangram: {
      maxClassesPerRealm: u64 & AugmentedConst<ApiType>;
      maxRealmsPerOrg: u64 & AugmentedConst<ApiType>;
      maxTokenPerClass: u128 & AugmentedConst<ApiType>;
      maxTotalToken: u128 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
