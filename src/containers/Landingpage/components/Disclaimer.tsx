...
export const Disclaimer = () => {
	...
	return (
		<Box p={[2,4]} mb={[2,4]} mx={'2rem'} sx={{ color: '#fff', border: '1px solid white' }}>
			<Typography variant={'h3'} pb={'1rem'}>Disclaimer</Typography>
			<Typography variant="caption" pb={'2rem'}>
				...
				In particular, this page and the Pinky Paper are not an Offer and do not imply a contractual relationship between GameDAO AG and an interested party.
